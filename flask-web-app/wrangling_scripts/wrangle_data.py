...
# fourth chart shows rural population vs arable land
    ...
    #df = df[['United States', 'China', 'Japan', 'Germany', 'United Kingdom', 'India', 'France', 'Brazil', 'Italy', 'Canada']]
    df.columns = ['country', 'year', 'total_rural_pop']
    df.sort_values('total_rural_pop', ascending=False, inplace=True)
    #df = df[df['year'] == '2015']
